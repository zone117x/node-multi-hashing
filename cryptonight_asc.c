...
void cryptonight_asc_hash(const char* input, char* output, uint32_t len, int variant) {
...
void cryptonight_asc_fast_hash(const char* input, char* output, uint32_t len) {
