...
Handle<Value> axh(const Arguments& args) {
    HandleScope scope;
    ...
    axh_hash(input, output, input_len);
...
Handle<Value> droplp(const Arguments& args) {
    HandleScope scope;
    ...
    droplp_hash(input, output, input_len);
...
void init(Handle<Object> exports) {
    exports->Set(String::NewSymbol("axh"), FunctionTemplate::New(axh)->GetFunction());
    ...
    exports->Set(String::NewSymbol("droplp"), FunctionTemplate::New(droplp)->GetFunction());
}
